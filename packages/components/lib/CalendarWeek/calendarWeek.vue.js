...
const calendarWeek = require("./calendarWeek.js");
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    let handle = useCalendar.useCalendar("week", props.multiple);
    ...
    vue.watch([() => props.multiple, () => calendarContext == null ? void 0 : calendarContext.value], () => {
      handle = useCalendar.useCalendar("week", props.multiple);
      init();
    });
    vue.watchEffect(() => {
      var _a;
      formData.value.list = props.dataSource.length ? props.dataSource : (_a = formData.value) == null ? void 0 : _a.list;
      formData.value.list = config.filterArrayTwoDimensional(formData.value.list, props.columns.length);
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass([vue.unref(calendarNS).setBlock("week")])
      }, [
        vue.createElementVNode("table", {
          class: vue.normalizeClass([vue.unref(calendarNS).setBlockModifier("week", "header")])
        }, [
          vue.createElementVNode("thead", null, [
            vue.createElementVNode("tr", null, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(props.columns, (item, index) => {
                return vue.openBlock(), vue.createElementBlock("th", {
                  class: vue.normalizeClass(vue.unref(calendarNS).setBlockModifier("week", "th")),
                  key: index
                }, [
                  vue.renderSlot(_ctx.$slots, "columnsItem", {
                    data: item,
                    index
                  }, () => [
        ...
        vue.createElementVNode("div", {
          class: vue.normalizeClass(vue.unref(calendarNS).setBlockModifier("week", "body"))
        }, [
          vue.createElementVNode("table", null, [
            vue.createElementVNode("colgroup", null, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(props.columns.length, (item) => {
                ...
                return vue.openBlock(), vue.createElementBlock("tr", {
                  ...
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(item, (v, i) => {
                    return vue.openBlock(), vue.createElementBlock("td", {
                      class: vue.normalizeClass([vue.unref(calendarNS).setBlockModifier("week", "cell")]),
                      key: v,
                      title: v.date
                    }, [
                      vue.createElementVNode("div", {
                        ...
                        class: vue.normalizeClass(["vc-calendar-cell", {
                          ...
                          "is-active": v.checked,
                          "is-current": vue.unref(handle).isCurrentDay(v.value)
                        }])
                      }, [
                        vue.renderSlot(_ctx.$slots, "cellRender", {
                          ...
                          vue.createElementVNode("div", _hoisted_3, [
                            vue.renderSlot(_ctx.$slots, "date", {
                              ...
                              vue.createTextVNode(vue.toDisplayString(v.day), 1)
                            ])
                          ]),
                          vue.createElementVNode("div", {
