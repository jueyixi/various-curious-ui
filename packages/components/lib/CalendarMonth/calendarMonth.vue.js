...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    let handle = useCalendar.useCalendar("month", props.multiple);
    ...
    const isInCurrentMonth = vue.computed(() => {
      return (date) => {
    ...
    vue.watch([() => props.multiple, () => calendarContext == null ? void 0 : calendarContext.value], () => {
      handle = useCalendar.useCalendar("month", props.multiple);
      init();
    });
    vue.watchEffect(() => {
      var _a;
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass([vue.unref(calendarNS).setBlock("month")])
      }, [
        vue.createElementVNode("table", {
          class: vue.normalizeClass([vue.unref(calendarNS).setBlockModifier("month", "header")])
        }, [
          vue.createElementVNode("thead", null, [
            vue.createElementVNode("tr", null, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(props.columns, (item, index) => {
                return vue.openBlock(), vue.createElementBlock("th", {
                  class: vue.normalizeClass(vue.unref(calendarNS).setBlockModifier("month", "th")),
                  key: index
                }, [
        ...
        vue.createElementVNode("div", {
          class: vue.normalizeClass(vue.unref(calendarNS).setBlockModifier("month", "body"))
        }, [
                ...
                return vue.openBlock(), vue.createElementBlock("tr", {
                  ...
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(item, (v, i) => {
                    return vue.openBlock(), vue.createElementBlock("td", {
                      class: vue.normalizeClass([vue.unref(calendarNS).setBlockModifier("month", "cell")]),
                      key: v,
                      title: v.date
                    }, [
                      vue.createElementVNode("div", {
