...
import { calendarWeekProps, calendarWeekEmits } from "./calendarWeek.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    let handle = useCalendar("week", props.multiple);
    const formData = ref({});
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([unref(calendarNS).setBlock("week")])
      }, [
        createElementVNode("table", {
          class: normalizeClass([unref(calendarNS).setBlockModifier("week", "header")])
        }, [
          createElementVNode("thead", null, [
            createElementVNode("tr", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(props.columns, (item, index) => {
                return openBlock(), createElementBlock("th", {
                  class: normalizeClass(unref(calendarNS).setBlockModifier("week", "th")),
                  key: index
                }, [
        ...
        createElementVNode("div", {
          class: normalizeClass(unref(calendarNS).setBlockModifier("week", "body"))
        }, [
                ...
                return openBlock(), createElementBlock("tr", {
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(item, (v, i) => {
                    return openBlock(), createElementBlock("td", {
                      class: normalizeClass([unref(calendarNS).setBlockModifier("week", "cell")]),
                      key: v,
                      title: v.date
                    }, [
                      createElementVNode("div", {
