...
import { isArray, isEnglish, isChinese } from "../packages/utils/is.js";
const _hoisted_1 = ["id"];
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("canvas", { id: canvasId.value }, " Your browser does not support the canvas element. ", 8, _hoisted_1);
    };
  }
});
export {
